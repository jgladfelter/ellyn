...
Activity.create!([
  {org_id: 1, name: "Dinosaurs v. Animals: Creatures- Lincoln Park M-F", desc: nil},
  {org_id: 2, name: "Drop-In ART: all ages", desc: "Ninety minutes to two hours of Open Studio Time for children and their caregivers. $10/child. (Children under one year are free when accompanied by paying child; adults are free.) Year-’round. No reservation required. Open to public."},
  {org_id: 2, name: "Writing and Illustrating for Kids ", desc: "Ages 8 & up. In this hybrid writing and art class, artists will utilize their creativity and critical thinking skills to combine visual art with the art of writing.  90 minutes. 10 weeks/$300 (8-week summer session: $250)"},
  {org_id: 3, name: "Children - Open", desc: "Open Classes for Children"},
  {org_id: 3, name: "Children - Private", desc: "Private Class"},
  {org_id: 4, name: "4yrs-6yrs Ballet/Tap", desc: "Introduction to the fundamentals of ballet and tap."},
  {org_id: 4, name: "Tap Class", desc: "Fundamentals of Tap."},
  {org_id: 3, name: "Self-Defense Class", desc: "Basics of Self-Defense."}
])
Event.create!([
